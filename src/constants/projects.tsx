      ...
      fullDescription: (
        <>
          ...
          <p>
            ...
            be used directly via a link or embedded via an iframe.
          </p>
          <p>
      ...
      fullDescription: (
        <>
          ...
          <p>
            ...
            <Link
              href="https://cal.com"
              aria-label="Open cal.com in a new tab"
              target="_blank"
              rel="nofollow noreferrer"
              className="main-text-color mx-1 hover:underline">
              Cal.Com
            </Link>
            software. The system is customized for the needs of SimpleTherapy (changed the structure of
            database, extended the roles and permissions of the users, integrated custom hooks etc.).
          </p>
        </>
      ),
